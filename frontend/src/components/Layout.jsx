    ...
    return (
        <div className="flex h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
            ...
            >
                ...
                <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                    <div className={`flex items-center ${isSidebarOpen ? '' : 'justify-center'}`}>
                        <div className="w-10 h-10 bg-gradient-success rounded-full flex items-center justify-center font-bold text-white shrink-0">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                {/* Top Header */}
                <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 h-16 flex items-center justify-between px-6 z-10">
                    <button
